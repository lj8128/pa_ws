...
if("TRUE" STREQUAL "TRUE")
  set(aruco_detect_SOURCE_PREFIX /my_ros_data/pa_ws/src/fiducials/aruco_detect)
  set(aruco_detect_DEVEL_PREFIX /my_ros_data/pa_ws/devel)
  ...
  set(aruco_detect_INSTALL_PREFIX /my_ros_data/pa_ws/install)
...
if(NOT "/my_ros_data/pa_ws/devel/include;/usr/include/opencv4 " STREQUAL " ")
  set(aruco_detect_INCLUDE_DIRS "")
  set(_include_dirs "/my_ros_data/pa_ws/devel/include;/usr/include/opencv4")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'aruco_detect' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/my_ros_data/pa_ws/src/fiducials/aruco_detect/${idir}'.  ${_report}")
    endif()
